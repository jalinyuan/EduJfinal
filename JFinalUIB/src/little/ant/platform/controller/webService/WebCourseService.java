package little.ant.platform.controller.webService;
...
public class WebCourseService extends BaseService {

	private static Logger log = Logger.getLogger(WebCourseService.class);

	public static final WebCourseService service = MyTxProxy.newProxy(WebCourseService.class);
	...
	public String save(Course course){
		// 保存
		course.save();
		String ids = course.getPKValue();
		
		// 缓存
		//Course.dao.cacheAdd(ids);
...
//	}
	...
	public void list(SplitPage splitPage) {
		String select = "select u.ids, u.coursename, u.classify, u.difficulty, u.description, u.createTime, u.chapterIds ";
		splitPageBase(DictKeys.db_dataSource_main, splitPage, select, "platform.course.splitPage");
	}
