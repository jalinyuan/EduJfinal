 ...
 * 登陆处理
 */
@Controller(controllerKey = "/jf/platform/webview/login")
public class WebLoginController extends BaseController {

	@SuppressWarnings("unused")
	private static Logger log = Logger.getLogger(WebLoginController.class);
	...
	public void index() {
		...
		if(null != user){//后台
			redirect("/jf/platform/webview/");
		    
		}else{
			render("/platform/webview/login.html");
		}
	}
	/**
	 * 验证账号是否存在
